...
Next, I hope to analysis pathway analysis for clusters generated through Hierarchical clustering and will upload.

I have uploaded my R script, cluter files, all matplots, heatmap under file section for this comparison.
